  ...
  <div class="white-wood">
    ...
    <div class="wrapper clearfix">
      ...
      <?php if ($_GET['s'] === 'success'){ ?>
       ...
       <p> Error. Your message was not sent. Make sure you type in the proper verfication numbers <a href= "contact.php">Click here to try again</a>. If issues persist please send an email to the site admin (admin@exceptionalrealty.com)
        <?php }else{ ?>
